...
<body>
      ...
      <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex justify-content-center" href="home.php?page=beranda" data-toggle="modal" data-target="#logoutModal">
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="?page=member" data-bs-toggle="collapse" data-bs-target="#MemberDropdown" aria-expanded="false">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="?page=buku" data-bs-toggle="collapse" data-bs-target="#BukuDropdown" aria-expanded="false">
      ...
      <?php if ($_SESSION['level'] == 'pustakawan') { ?>
      <li class="nav-item">
  ...
  <div class="text-center p-4">
    © 2023 UAS | <a class="text-reset fw-bold" href="">KELOMPOK_5</a>
  </div>
  <!-- End Footer -->
